...
namespace LogisticCompany_Identity.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Model,Year,PlateNumber,Capacity")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Model,Year,PlateNumber,Capacity")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
